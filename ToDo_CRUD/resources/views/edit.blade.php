  ...
  <div class="col-md-6">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Edit Confirm Attendance</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      <form method="post" action="{{route('confirm_attendance_update')}}" >
        @csrf
        <div class="card-body">

        <div class="form-group">
            <label for="name">EmId</label>
            <input type="hidden"  class="form-control" id="id" name="id"  value="{{ $todos->id }}" >
